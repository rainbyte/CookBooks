 ...
 * @author T3G
 */
public class WarningDeleteAuthor extends JDialog {
	 ...
	 * Create the frame.
	 */
	public WarningDeleteAuthor(long id1) {
		...
		panel.setBorder(new TitledBorder(new EtchedBorder(EtchedBorder.LOWERED, null, null), "Baja de un Autor", TitledBorder.LEADING, TitledBorder.TOP, null, null));
		panel.setBounds(82, 11, 224, 71);
		contentPane.add(panel);
		
		JLabel lblDebeIniciarSesin = new JLabel("Esta a punto de eliminar un Autor");
		...
		btnConfirmarBaja.addMouseListener(new MouseAdapter() {
			...
			public void mousePressed(MouseEvent arg0) {
				// Remove from db
				try {
					Database.getAuthorDao().deleteById(id);
